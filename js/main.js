$(document).ready(function() {
    ...
    for (var i = 0; i < products.length; i++) {
        ...
        item += "<li> <img src='" + products[i].imageS + "'>"; 
        item += "<h3 class='name'> " + products[i].name; + "</h3>";

//      if(products[i].params.region || products[i].params.land || products[i].params.art) {
            item += "<p class='country'>";
//      }
        
        if(products[i].params.region) {
            item += "<span class='region'> " + products[i].params.region + "</span> | ";
        }

        if(products[i].params.land) {
            item += "<span class='land'> " + products[i].params.land + " </span> | ";
        }
        
        if(products[i].params.art) {
            item += "<span class='art'> " + products[i].params.art + " </span>";
        }
...
//        }
        ...
        item += "<p class='cost'><span class='priceText'> " + products[i].priceText + "</span>"; 
        item += "<span class='oldPriceText'> " + products[i].oldPrice + " </span></p>";
        item += "<p class='basePrice'>" + products[i].params.basePrice + "</p></li>";
    }
